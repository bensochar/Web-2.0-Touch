...
<div class="content">
	...
	<ul class="rounded">
		...
		<li><a href="javascript: myTouch.loadPage('pages/animations.php', { transition: 'slide-up' });">Slide Up</a></li>
		<li><a href="javascript: myTouch.loadPage('pages/animations.php', { transition: 'slide-down' });">Slide Down</a></li>
	</ul>
	<ul class="rounded">
		...
		<li><a href="javascript: myTouch.loadPage('pages/animations.php', { transition: 'flip-top' });">Flip Top</a></li>
		<li><a href="javascript: myTouch.loadPage('pages/animations.php', { transition: 'flip-bottom' });">Flip Bottom</a></li>
	</ul>
	<ul class="rounded">
		<li><a href="javascript: myTouch.loadPage('pages/animations.php', { transition: 'pop-in' });">Pop In</a></li>
		<li><a href="javascript: myTouch.loadPage('pages/animations.php', { transition: 'pop-out' });">Pop Out</a></li>
	</ul>
